...
namespace ActiviteChart.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update ActiviteChartDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update ActiviteChartEfCoreEntityExtensionMappings to extend the IdentityUser entity
