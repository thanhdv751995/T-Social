...
namespace Extention.Management.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update ManagementDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update ManagementEfCoreEntityExtensionMappings to extend the IdentityUser entity
